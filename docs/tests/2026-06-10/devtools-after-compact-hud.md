...
| number-2048 | 1024x600 | no | 82 | 2 | 2 | 996 | Controls всё ещё частично ниже fold. |
| step-tetris | 1024x600 | no | 82 | 0 | 0 | 1450 | Controls не видны в первом viewport, нужен отдельный layout-fix. |
...
| number-2048 | 800x600 | no | 116 | 0 | 0 | 1407 | Controls не видны в первом viewport, нужен отдельный layout-fix. |
| step-tetris | 800x600 | no | 116 | 0 | 0 | 1417 | Controls не видны в первом viewport, нужен отдельный layout-fix. |
...
- Не считать P0 layout полностью закрытым: `number-2048` и `step-tetris` требуют отдельного compact board/controls layout.
