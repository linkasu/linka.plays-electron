...
Собрать дневное расписание из крупных AAC-карточек в порядке. Ошибка не подсвечивает и не озвучивает правильную карточку, а просит ещё раз посмотреть на порядок дня.
