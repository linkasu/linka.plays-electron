...
Ребёнок ищет частично скрытого персонажа в спокойной фигура-фон сцене. Игра тренирует зрительный поиск, выделение объекта и выбор.
...
- TTS подробно проговаривает старт, цель раунда, мягкий успех, ошибку без наказания и конкретную подсказку по укрытию.
