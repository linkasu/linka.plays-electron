...
Игра тренирует распознавание эмоций по ситуации или лицу. Ребёнок выбирает подходящую AAC-карточку с эмоцией, получает подтверждение, а при повторной попытке видит подсказку.
...
```text
показ ситуации или лица -> выбор карточки эмоции -> озвучивание выбранной эмоции или подсказка -> следующий AAC-раунд
```
...
- После повторной попытки выбранная карточка приглушается; целевая карточка не подсвечивается и не называется.
