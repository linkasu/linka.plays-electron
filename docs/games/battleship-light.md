...
Ребёнок выбирает крупные клетки на спокойном поле поиска. Звуковой и голосовой отклик короткий, необязательный и не мешает повторной попытке.

Самостоятельная формулировка для меню: найди корабли.
