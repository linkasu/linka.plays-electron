...
Показаны emoji/картинка и слово, которое нужно собрать по буквам. Ребёнок выбирает буквы взглядом на большой клавиатуре; повторная попытка не сдвигает текущую букву и не добавляет голосовую подсказку.
