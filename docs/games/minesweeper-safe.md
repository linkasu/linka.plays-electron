...
Спокойная версия сапёра: ребёнок открывает клетки по числовым подсказкам, может включить режим `Бомба` и помечать мины флажками. Победа наступает, когда все бомбы помечены и безопасные клетки не помечены. TTS звучит только в начале раунда.
