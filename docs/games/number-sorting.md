...
Выбирать числа по возрастанию или убыванию. Интерфейс показывает прогресс, но не раскрывает следующее правильное число.

Самостоятельная формулировка для меню: выбери следующее число.
