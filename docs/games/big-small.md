...
Выбрать большой или маленький вариант предмета. Ошибка не подсвечивает и не озвучивает правильную карточку сверх исходного задания.

Самостоятельная формулировка для меню: выбери большой или маленький.
