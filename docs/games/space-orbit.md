...
Ребёнок ведёт ракету взглядом или мышью по орбите и удерживается рядом со светлой звездой. Звезда засчитывается только при валидном input.

Самостоятельная формулировка для меню: собери звёзды на орбите.
