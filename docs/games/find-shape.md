...
| Skills | поиск, выбор, классификация |
...
- Минимальная short-side эвристика targets: 0.261.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `FindShapeGame.vue` |
| Model | `model.ts` |
| Model test | `model.test.ts` |
| Audio module | нет |
| Runtime audit doc | `docs/tests/2026-06-10/find-shape.md` |
