...
- Минимальный целевой размер из registry: 165 px.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `JellyfishGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/jellyfish.md` |
