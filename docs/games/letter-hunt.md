...
| Skills | поиск, переключение, словарь |
...
Ребёнок ловит заданную букву взглядом в сцене с постепенно плывущими символами. Игра тренирует внимание, поиск буквы и переключение взгляда.

Самостоятельная формулировка для меню: поймай букву взглядом.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `LetterHuntGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/letter-hunt.md` |
...
- TTS проговаривает букву-задание, успех и ошибку с повтором задания.
