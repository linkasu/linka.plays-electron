...
Ребёнок смотрит на большое солнце, лучи постепенно раскрываются, а при уходе взгляда солнце ждёт. Игра тренирует устойчивую фиксацию.

Самостоятельная формулировка для меню: открой лучи солнца.
...
- Основная сцена рисуется на canvas: солнце, лучи, облака и искры должны оставаться и не мигать резко.
