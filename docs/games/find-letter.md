...
Ребёнок выбирает заданную крупную букву среди нескольких вариантов. Игра тренирует визуальный поиск, узнавание букв и выбор.

Самостоятельная формулировка для меню: найди букву.
...
- TTS проговаривает букву-задание, успех и ошибку с повтором нужной буквы.
