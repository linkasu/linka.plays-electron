...
Ответить по простому столбиковому графику: где больше, где меньше или сколько у указанного столбика. Вопрос каждого раунда озвучивается через TTS. Ошибка не раскрывает правильный столбик или число.

Самостоятельная формулировка для меню: ответь по графику.

## Игровой цикл

```text
озвучивание вопроса -> показ столбикового графика -> выбор ответа крупной целью -> проверка -> следующий пример
```
