...
Игра тренирует классификацию: ребёнок смотрит на предмет и выбирает подходящую полку. Задание держит крупные цели, мягкую подсказку и понятный визуальный результат: предмет оказывается на выбранной полке.
...
- После неверного выбора выбранная полка мягко откликается, а подходящая подсвечивается.
