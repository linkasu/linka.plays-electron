...
Ребёнок выбирает следующую точку или выход в широком лабиринте взглядом. Игра тренирует пошаговое движение по маршруту и внимание к подсказке.

Самостоятельная формулировка для меню: найди выход взглядом.
