...
Найти число, следующее число или предыдущее число на дорожке от 1 до 10. TTS озвучивает конкретное задание: найти число, что идёт после или что идёт перед. Ошибка просит попробовать другой вариант без подсветки правильного числа.

Самостоятельная формулировка для меню: выбери число на дорожке.
