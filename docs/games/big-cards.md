...
Ребёнок выбирает одну из крупных карточек взглядом. Игра помогает отработать понятный gaze-first выбор с большими стабильными зонами и мышиным fallback.

Самостоятельная формулировка для меню: выбери карточку взглядом.
