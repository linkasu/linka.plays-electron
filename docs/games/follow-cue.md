...
Ребёнок следует за стрелкой и световой подсказкой к следующей крупной цели. Игра тренирует визуальный поиск, переключение внимания и выбор.
...
- TTS проговаривает инструкцию следовать за стрелкой, успех и ошибку с повтором подсказки.
