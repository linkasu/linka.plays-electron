...
- Верный выбор, ошибка и завершение получают короткую нейтральную TTS-фразу и мягкий piano-feedback.
- Пока звучит TTS/feedback, выбор заблокирован.
- Ошибка не подсвечивает и не называет следующий правильный вагон.
