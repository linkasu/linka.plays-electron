...
Ребёнок смотрит на постепенно падающие снежинки, и рядом со взглядом они светятся и тают. Игра поддерживает слежение взглядом и фиксацию.

Самостоятельная формулировка для меню: растопи снежинки взглядом.
