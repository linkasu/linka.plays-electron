...
Ребёнок ведёт лодочку взглядом или мышью по спокойной реке и проходит мягкие светлые ворота. Засчитывание требует валидного input рядом с воротами.

Самостоятельная формулировка для меню: веди лодочку по реке.
