...
Продолжать цветовой ряд AB, ABC или ABB крупной карточкой, удерживая внимание на повторе без раскрывающей подсказки после ошибки.

Самостоятельная формулировка для меню: продолжи цветовой ряд.
