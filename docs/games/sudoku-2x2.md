...
Заполнить пустую клетку судоку с постепенным усложнением от 2×2 до 5×5. В текущем поле в каждой строке и столбце должны быть числа от 1 до размера поля. Ошибка не раскрывает правильную карточку и не подсвечивает ответ.
