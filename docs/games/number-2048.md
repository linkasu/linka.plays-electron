...
Пошаговая версия 2048с крупными направлениями: ребёнок двигает всё поле, замечает слияния и завершает доску, если ходов нет.

Самостоятельная формулировка для меню: Сдвигай плитки, соединяй одинаковые числа и ищи следующий ход.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `Number2048Game.vue` |
| Model | `model.ts` |
| Model test | `model.test.ts` |
| Audio module | нет |
| Runtime audit doc | `docs/tests/2026-06-10/number-2048.md` |
