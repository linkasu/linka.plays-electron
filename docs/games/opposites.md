...
Выбрать противоположное слово из крупных AAC-карточек. Ошибка не подсвечивает и не озвучивает правильную карточку.

Самостоятельная формулировка для меню: найди противоположность.
