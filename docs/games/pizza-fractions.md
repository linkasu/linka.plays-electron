...
Выбрать целую пиццу, половину или четверть. Стартовая TTS-подсказка называет нужную долю; ошибка не подсвечивает правильную долю и не раскрывает новый ответ.
