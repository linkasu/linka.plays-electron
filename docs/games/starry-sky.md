...
Ребёнок соединяет звёзды по порядку и видит простое созвездие после завершения. Игра тренирует последовательный взгляд, внимание и спокойный переход между точками.
