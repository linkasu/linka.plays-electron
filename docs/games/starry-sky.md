...
| Skills | фиксация, переключение, последовательность |
| Recommended session | 210 сек |
...
- Рекомендуемая длительность занятия: 210 сек.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `StarrySkyGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/starry-sky.md` |
