...
Ребёнок соединяет звёзды по порядку и видит простое созвездие после завершения. Игра тренирует последовательный взгляд, внимание и переход между точками.

Самостоятельная формулировка для меню: нарисуй созвездия взглядом.
