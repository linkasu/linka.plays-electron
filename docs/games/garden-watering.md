...
Ребёнок ведёт лейку взглядом или мышью и мягко поливает цветы в любом порядке. Рост цветов накапливается постепенно и без обязательного маршрута.

Самостоятельная формулировка для меню: полей цветы взглядом.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `GardenWateringGame.vue` |
| Model | `model.ts` |
| Model test | `model.test.ts` |
| Audio module | нет |
| Runtime audit doc | `docs/tests/2026-06-10/garden-watering.md` |
