...
Ребёнок удерживает взгляд на световой цели, затем цель переезжает в новую зону. Игра тренирует фиксацию и безопасное переключение внимания.

Самостоятельная формулировка для меню: поймай свет взглядом.
