...
| Пузыри | `bubble-pop` | [bubble-pop.md](bubble-pop.md) | `therapy-ready` | `publish` | `ready` |
...
| 2048 | `number-2048` | [number-2048.md](number-2048.md) | `therapy-ready` | `publish` | `ready` |
...
| Тетрис | `step-tetris` | [step-tetris.md](step-tetris.md) | `therapy-ready` | `publish` | `ready` |
...
| Змейка | `route-snake` | [route-snake.md](route-snake.md) | `therapy-ready` | `publish` | `ready` |
...
| Машинка на дороге | `road-car` | [road-car.md](road-car.md) | `therapy-ready` | `publish` | `ready` |
