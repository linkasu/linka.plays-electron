...
Выбрать действие, которое происходит сначала или потом. Ошибка оставляет тот же вопрос для повторной попытки и не раскрывает полный порядок.

Самостоятельная формулировка для меню: выбери, что сначала, а что потом.
