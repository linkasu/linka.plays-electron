...
Ребёнок собирает роботика по шагам: голова, корпус, руки и ноги. Игра тренирует последовательность действий и спокойный выбор нужной детали.

Самостоятельная формулировка для меню: собери роботика по порядку.
...
- TTS проговаривает текущую деталь-задание, мягкий успех и спокойную ошибку без подсветки ответа.
