...
Ребёнок собирает роботика по шагам: голова, корпус, руки и ноги. Игра тренирует последовательность действий и выбор нужной детали.
...
- TTS проговаривает текущую деталь-задание, успех и ошибку без подсветки ответа.
