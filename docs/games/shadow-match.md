...
Ребёнок подбирает правильную тень к крупному изображению предмета. Игра тренирует сравнение формы, предметное узнавание и выбор.

Самостоятельная формулировка для меню: найди тень предмета.

## Игровой цикл

```text
показ предмета -> поиск правильной тени среди крупных вариантов -> dwell-выбор -> feedback -> следующий раунд
```
...
- TTS объясняет задачу без подсказки правильного предмета, успех и ошибку с повтором задания.
