...
## Назначение
 ...
 партия в домино против простого бота: ребёнок выбирает костяшку из руки, сравнивает её числа с открытыми концами цепочки и ставит подходящую костяшку слева или справа.
...
- После успешного хода игрока бот делает один ход: ставит подходящую костяшку или берёт одну костяшку из базара.
