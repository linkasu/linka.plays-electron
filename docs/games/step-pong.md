...
Ребёнок выбирает позицию ракетки на линии мяча. Раунд остаётся пошаговым и: после ошибки показывается подсказка, а финальный результат ждёт feedback и озвучку.
