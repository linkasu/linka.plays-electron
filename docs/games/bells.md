...
Ребёнок выбирает крупный колокольчик взглядом и получает визуальный отклик. Игра тренирует выбор между большими целями без требования быстрого ответа.

Самостоятельная формулировка для меню: позвони в колокольчик взглядом.
...
- Минимальная short-side эвристика targets: 0.329.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `BellsGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | нет |
| Runtime audit doc | `docs/tests/2026-06-10/bells.md` |
