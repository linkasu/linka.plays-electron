...
Ребёнок выбирает крупный колокольчик взглядом и получает мягкий визуальный отклик. Игра тренирует спокойный выбор между большими целями без требования быстрого ответа.
