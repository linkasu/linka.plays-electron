...
Ребёнок ищет заданную цифру среди крупных карточек. Игра поддерживает узнавание цифр, визуальный поиск и выбор взглядом.

Самостоятельная формулировка для меню: найди цифру.
...
- Минимальная short-side эвристика targets: 0.3.
...
- TTS проговаривает цифру-задание, успех и ошибку с повтором нужной цифры.
