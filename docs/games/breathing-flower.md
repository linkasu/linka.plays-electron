...
Ребёнок смотрит в центр цветка, а цветок постепенно раскрывается и закрывается. Игра поддерживает фиксацию, слежение взглядом и ритм без соревновательного давления.

Самостоятельная формулировка для меню: подыши вместе с цветком.
