...
Ребёнок ищет картинку, которая совпадает с образцом. Игра тренирует сравнение, визуальный поиск и выбор между крупными карточками.

Самостоятельная формулировка для меню: найди такую же картинку.
...
- TTS проговаривает инструкцию найти такую же картинку, успех и ошибку с повтором задания.
