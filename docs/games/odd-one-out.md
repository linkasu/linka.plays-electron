...
| Skills | классификация, выбор, поиск |
...
- Минимальная short-side эвристика targets: 0.199.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `OddOneOutGame.vue` |
| Model | `model.ts` |
| Model test | `model.test.ts` |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/odd-one-out.md` |
