...
Ребёнок ищет нужный цвет среди крупных карточек. Игра тренирует визуальный поиск, узнавание цвета и спокойный выбор взглядом.
...
- TTS проговаривает цвет-задание, мягкий успех и спокойную ошибку с повтором нужного цвета.
