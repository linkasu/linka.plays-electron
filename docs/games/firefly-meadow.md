...
Ребёнок смотрит на поляну и зажигает светлячков взглядом. Игра развивает фиксацию и переключение между зонами.

Самостоятельная формулировка для меню: зажги светлячков взглядом.
