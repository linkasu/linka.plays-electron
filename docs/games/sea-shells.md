...
Ребёнок открывает крупные морские ракушки взглядом, внутри появляется свет и жемчужина. Игра тренирует фиксацию и переключение между целями.

Самостоятельная формулировка для меню: открой ракушку взглядом.
