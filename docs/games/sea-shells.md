...
Ребёнок открывает крупные морские ракушки взглядом, внутри появляется мягкий свет и жемчужина. Игра тренирует фиксацию и переключение между спокойными целями.
