...
Собрать бытовые события по частям дня: утро, день и вечер. Ошибка даёт нейтральную просьбу посмотреть на текущую часть дня, без называния правильной карточки.

Самостоятельная формулировка для меню: разложи день по порядку.
...
Игра находится в группе `needs-check`, пока проходит ручной adaptive/audio review.
