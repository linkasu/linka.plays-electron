...
- Последний Electron CDP audit: failures = 0, max targets = 8, min visible targets = 8.
- Минимальная short-side эвристика targets: 0.209.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `LightGalleryGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/light-gallery.md` |
