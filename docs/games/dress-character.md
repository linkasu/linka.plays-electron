...
- Верный выбор и повторная попытка сопровождаются мягким piano-feedback и нейтральной TTS-фразой без ответа.
- Пока звучит TTS/feedback, выбор одежды заблокирован.
- Повторная попытка не подсвечивает правильный ответ и не раскрывает его отдельной подсказкой.
...
- Повторная попытка не должна подсвечивать правильную одежду.
