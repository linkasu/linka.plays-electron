...
Сварить суп, добавляя ингредиенты по порядку рецепта. Ошибка не подсвечивает правильный ингредиент и не озвучивает его название.

Самостоятельная формулировка для меню: добавь ингредиенты по рецепту.
