...
- Рекомендуемая длительность занятия: 95 сек.
...
|---|---|
| Route в router | есть |
| Vue-компонент | `LighthouseGame.vue` |
| Model | нет отдельной модели |
| Model test | нет |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/lighthouse.md` |
