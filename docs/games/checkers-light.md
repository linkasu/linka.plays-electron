...
Упрощённые шашки 4×4: ребёнок выбирает доступную шашку, затем отмеченную клетку для диагонального хода.

Самостоятельная формулировка для меню: Выбери шашку и сделай ход по диагонали.
