...
Ребёнок выбирает следующую точку на спокойной лабиринтной дорожке. Правильная точка не подсвечивается заранее; после обхода ребёнок получает нейтральный feedback без раскрытия ответа.

Самостоятельная формулировка для меню: выбери безопасную точку.
