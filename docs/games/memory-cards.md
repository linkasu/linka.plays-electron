...
Ребёнок открывает две карточки и ищет одинаковые пары. Игра тренирует зрительную память, выбор и переключение внимания.
...
- TTS объясняет задачу без подсказки пар, успех и несовпадение.
