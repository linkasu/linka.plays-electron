...
Ребёнок ищет названное животное среди крупных карточек. Игра поддерживает словарь, визуальный поиск и gaze-first выбор.

Самостоятельная формулировка для меню: найди животное.
...
- TTS проговаривает животное-задание, успех и ошибку с повтором задания.
