...
|---|---|
| Route в router | есть |
| Vue-компонент | `FindAnimalGame.vue` |
| Model | `model.ts` |
| Model test | `model.test.ts` |
| Audio module | `audio.ts` |
| Runtime audit doc | `docs/tests/2026-06-10/find-animal.md` |
...
- TTS проговаривает животное-задание, мягкий успех и спокойную ошибку с повтором задания.
