...
describe("wordImageSrc", () => {
  it("builds stable ASCII asset paths from word ids", () => {
    expect(wordImageSrc("apple", "./", "file:///app/dist/index.html")).toBe(
      "file:///app/dist/images/words/apple.png",
    );
    expect(wordImageSrc("ice_cream", "./", "file:///app/dist/index.html")).toBe(
      "file:///app/dist/images/words/ice_cream.png",
    );
  });

  it("encodes unsafe path characters", () => {
    expect(wordImageSrc("word/name", "./", "https://example.test/index.html")).toBe(
      "https://example.test/images/words/word%2Fname.png",
    );
  });
