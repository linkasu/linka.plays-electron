...
export const musicalPathStoneTemplate: readonly Omit<MusicalPathStone, "selected" | "softError">[] = [
  ...
  { id: "sol", order: 5, note: "соль", icon: "mdi-music-note-eighth", x: 61, y: 52, mobileX: 29, mobileY: 54, hue: 154 },
  { id: "la", order: 6, note: "ля", icon: "mdi-music-note", x: 72, y: 46, mobileX: 69, mobileY: 47, hue: 124 },
  { id: "si", order: 7, note: "си", icon: "mdi-music-clef-treble", x: 83, y: 40, mobileX: 34, mobileY: 40, hue: 36 },
  { id: "do-high", order: 8, note: "до", icon: "mdi-music-note", x: 91, y: 34, mobileX: 72, mobileY: 34, hue: 14 }
];
