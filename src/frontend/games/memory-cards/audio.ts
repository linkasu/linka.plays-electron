...
const matchMelody: SoftPianoMelody = {
  notesToLoad,
  sampled: [
...
const mismatchMelody: SoftPianoMelody = {
  notesToLoad,
  sampled: [
...
export function playMemoryCardsMatchMelody(enabled: boolean) {
  return playSoftPianoMelody(enabled, matchMelody);
}

export function playMemoryCardsMismatchMelody(enabled: boolean) {
  return playSoftPianoMelody(enabled, mismatchMelody);
}
