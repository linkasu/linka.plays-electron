...
export const openDoorRewards: OpenDoorReward[] = [
  {
    ...
    color: "#e6a425",
    glow: "#ffe5a3",
    ttsId: "open-door.warm-light",
  },
  {
    id: "pink-heart",
    icon: "mdi-heart",
    label: "розовое сердце",
    color: "#dc5f8b",
    glow: "#ffc2d6",
    ttsId: "open-door.pink-heart",
  },
  {
    id: "green-flower",
    icon: "mdi-flower",
    label: "зелёный цветок",
    color: "#54a96b",
    glow: "#c9f4c7",
    ttsId: "open-door.green-flower",
  },
  {
    id: "violet-star",
    icon: "mdi-star",
    label: "фиолетовая звезда",
    color: "#9a64c5",
    glow: "#f9e7ff",
    ttsId: "open-door.violet-star",
  },
  {
    id: "sun-ray",
...
export function createOpenDoorState(
  maxSteps = 8,
...
export function revealOpenDoor(
  state: OpenDoorState,
  random: () => number = Math.random,
): OpenDoorState {
