...
export const wantDontWantItems: WantDontWantItem[] = [
  {
    ...
    emoji: "💧",
    kind: "предмет",
    phrases: { want: "Я хочу пить воду", dontWant: "Я не хочу пить воду" },
  },
  {
    id: "apple",
    wordId: "apple",
    ...
    emoji: "🍎",
    kind: "предмет",
    phrases: { want: "Я хочу есть яблоко", dontWant: "Я не хочу есть яблоко" },
  },
  {
    id: "music",
    wordId: "drum",
    ...
    emoji: "🎵",
    kind: "занятие",
    phrases: { want: "Я хочу слушать музыку", dontWant: "Я не хочу слушать музыку" },
  },
  {
    id: "book",
    wordId: "book",
    ...
    emoji: "📖",
    kind: "предмет",
    phrases: { want: "Я хочу читать книгу", dontWant: "Я не хочу читать книгу" },
  },
  {
    id: "ball",
    wordId: "ball",
    ...
    emoji: "🟡",
    kind: "предмет",
    phrases: { want: "Я хочу играть в мяч", dontWant: "Я не хочу играть в мяч" },
  },
  {
    id: "draw",
    wordId: "pencil",
    ...
    emoji: "🖍️",
    kind: "занятие",
    phrases: { want: "Я хочу рисовать", dontWant: "Я не хочу рисовать" },
  },
  {
    id: "toy",
    wordId: "toy",
    title: "играть с игрушкой",
    emoji: "🧸",
    kind: "предмет",
    phrases: { want: "Я хочу играть с игрушкой", dontWant: "Я не хочу играть с игрушкой" },
  },
  {
    id: "rest",
    wordId: "bed",
    ...
    emoji: "🌙",
    kind: "занятие",
    phrases: { want: "Я хочу отдыхать", dontWant: "Я не хочу отдыхать" },
  },
  {
    id: "hug",
    wordId: "heart",
    ...
    emoji: "🫶",
    kind: "занятие",
    phrases: { want: "Я хочу обниматься", dontWant: "Я не хочу обниматься" },
  },
];
...
export function createWantDontWantCommunication(
  item: WantDontWantItem,
  answer: WantDontWantAnswer,
) {
...
export function generateWantDontWantRound(roundIndex = 1): WantDontWantRound {
  if (wantDontWantItems.length === 0)
    throw new Error("Недостаточно предметов для игры Хочу / не хочу.");
