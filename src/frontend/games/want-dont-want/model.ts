...
export const wantDontWantItems: WantDontWantItem[] = [
  ...
  { id: "apple", title: "есть яблоко", emoji: "🍎", kind: "предмет" },
  { id: "music", title: "слушать музыку", emoji: "🎵", kind: "занятие" },
  { id: "book", title: "читать книгу", emoji: "📖", kind: "предмет" },
  { id: "ball", title: "играть в мяч", emoji: "🟡", kind: "предмет" },
  { id: "draw", title: "рисовать", emoji: "🖍️", kind: "занятие" },
  { id: "toy", title: "играть с игрушкой", emoji: "🧸", kind: "предмет" },
