...
const { session, durationMs, metrics, recommendation, pauseSession, resumeSession, recordEvent, recordHint, recordSuccess, startSession } = useGameSession("guide-fish", {
  preset: "gentle",
  maxSteps: 8,
  dwellMs: 600,
  sessionSeconds: 150,
