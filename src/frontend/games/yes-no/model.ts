import { getAllWords, sampleItems, type WordItem } from "../../data/wordBank";
...
export function generateYesNoRound(roundIndex = 1): YesNoRound {
  ...
  const [distractor] = sampleItems(words, 1, [item]);
