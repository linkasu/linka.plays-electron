...
export const wordBank: WordItem[] = [
  ...
  { id: "comb", word: "расчёска", emoji: "〽️", category: "thing" },
  ...
  { id: "shovel", word: "лопата", emoji: "♠️", category: "thing" },
  ...
  { id: "wave", word: "волна", emoji: "〰️", category: "nature" },
  { id: "island", word: "остров", emoji: "🏝️", category: "nature" },
  { id: "sand", word: "песок", emoji: "🟨", category: "nature" },
