...
export const games: GameInfo[] = [
  ...
  {
    id: "match-same",
    title: "Покажи такое же",
    description: "Найди картинку, которая совпадает с образцом.",
    selfDescription: "Покажи такую же картинку.",
  ...
  },
  {
    ...
    description: "Прочитай слово и выбери подходящую картинку; название цели не озвучивается.",
    selfDescription: "Прочитай слово и выбери картинку.",
    route: "/games/choose-picture",
    category: "language-aac",
    icon: "mdi-image-search",
    skills: ["vocabulary", "choice", "visual-search"],
    status: "polished",
    stabilityStatus: "publish",
    recommendedSessionSeconds: 120,
    minTargetSizePx: 180,
